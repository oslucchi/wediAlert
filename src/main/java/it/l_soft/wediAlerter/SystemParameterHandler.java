...
public class SystemParameterHandler {
	final static Logger log = LoggerFactory.getLogger(SystemParameterHandler.class); 
	...
	public static float getCPUTemp()
	{
		try {
			...
			log.error("Exception reading system temperature", e);
		}
		return 0;
	}
	/*
	 ...
	 */	 
	public void dumpAll() throws InterruptedException, IOException, ParseException {
